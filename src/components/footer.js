      ...
      <div className="container">
        <div className="row g-4">
          ...
          <div className="col-md-7">
            <h5 className="fw-semibold mb-1 text-uppercase" style={{ color: "#234970" }}>Financiadores</h5>
            <div className="d-flex flex-wrap align-items-center gap-4">
              <img src={ue} alt="União Europeia" className="img-fluid" style={{ maxHeight: "60px" }} />
              <img src={rp} alt="República Portuguesa" className="img-fluid" style={{ maxHeight: "60px" }} />
              <img src={fct} alt="FCT" className="img-fluid" style={{ maxHeight: "90px" }} />
